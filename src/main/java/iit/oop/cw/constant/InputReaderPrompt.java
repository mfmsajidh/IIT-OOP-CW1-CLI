...
public class InputReaderPrompt {

    // Vehicle Details
    public static final String VEHICLE_NUMBER_PLATE = "Enter vehicle number plate";
    public static final String VEHICLE_TYPE = "Enter one of the [] values for vehicle type";
